...
**Write your ANSWER HERE: Access to technology may limit who is able to complete a survey, causing those with higher incomes to be overrepresented and those with lower incomes to be underrepresented. Many times, these socioecomonic measures in life can impact your education level, which means those able to go to college have higher incomes and those who only completed some high school or only graduated high school have lower incomes. There may also be response bias. Those with higher education levels tend to participate in surveys more than those with lower education bias.**
...
**Write your ANSWER HERE: Voting intentions rise with education level, initial survey data finds.**
...
**Write your ANSWER HERE: The biggest changes occurred for "high school or less," when the unweighted number (73.51) became 70.77 when weighted. "Some college" changed more than "college" but not as much as "high school or less." "College" only changed by a few hundredths, from 93.43 to 93.48.**

2. Why might the weighted results be considered more accurate than the unweighted results?

**Write your ANSWER HERE: Greater emphasis and importance is placed on certain certain data points for weighted data (more emphasis on college weight because it's harder to achieve a degree and get into college), whereas unweighted results are all weighed equally.**
...
**Write your ANSWER HERE: High school or less**
...
**Write your ANSWER HERE: If journalists were to only use unweighted surveys when reporting, they would have data that isn't representative of the population. This can also cause under or overrepresentation of certain groups. Looking at weighted data gives a better generalization of the overall population most of the time.**

2. How might the differences between weighted and unweighted results affect how you would report on this data?

**Write your ANSWER HERE: With weighted data, I can better relate it to the population without worrying about over or under representation. With unweighted data, I would have to preface that I used unweighted results, and I would worry the whole time I'm writing the article whether my information is accurate or not.**
...
**Write your ANSWER HERE: What demographic factors came into play when calculating the weights or handing out surveys? (age, race, income, region, gender - everything other than education since we know that demographic was used to create the data)**
