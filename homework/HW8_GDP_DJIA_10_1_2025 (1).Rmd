...
gdp_data |> 
  ...
  labs(title = "Relationship Between DJIA and GDP")
```
...
ANSWER: There is a very strong correlation between the DJIA and the GDP data. It's a positive correlation (0.95). The stock market and GDP are very similar in their values, even though the GDP seems to increase at a quicker rate than the DJIA. With the state of the economy right now, I wonder if this correlation will stay as strong as it was from 2013 to 2024.
