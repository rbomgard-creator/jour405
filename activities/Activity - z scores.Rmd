...
**The number of overdose calls seems to be relatively low, ranging between 7 and 17. There are some outliers, but the number of calls stays in the low 20s and never exceeds 23.**
...
**Our estimation of range was off. Instead of 7-17 being the normal, it's 4 to 17 calls per day. Unusually high numbers include anything 18 or up, and unually low numbers are are 1-3.**
...
**Saturdays shows the highest average of overdose calls a day (11.3), while Thursdays show the least (9.4). What's interesting about this data are Tuesdays. They show the fourth highest average of calls for the week (10.3), behind weekend days.**
...
**Why do Tuesdays stand out among a higher average of calls for a day of the week, or the workweek? Why are there spikes in the winter? I would want to research the economic backgrounds of the neighborhoods within Baltimore County to get a better outlook on where calls might be coming from. Is there a certain neighborhood that would be listed as higher class that overdose calls are coming from? Are these neighborhoods outliers themselves? Are there any events or context to why some days are unusually high or low? These are things I'd want to look into.**
