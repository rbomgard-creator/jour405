...
**Task 3: Write your answer here: Private colleges have the highest mean and median scores, with community colleges having the lowest mean, median, and minimum scores. Private and public colleges share the same max score of 1600, but private schools have a lower standard deviation, meaning more students are achieving higher SAT scores than at public schools. **
...
1. Is there a significant difference in SAT scores across college types? Yes, it passes all of the thresholds when we run an ANOVA test.
2. Which specific college types differ from each other? Community colleges differ the most from public and private colleges. 
3. How large are these differences? On average, private colleges have SAT scores 366.96 points higher than community colleges, while public colleges are 292.55 points above community colleges.
...
Study finds that private colleges admit students with higher SAT scores.

A study conducted by University of Maryland journalism students finds that SAT scores increase with the type of college attended. For example, community colleges have an average SAT score of 1068, public 1360, and private 1435. However, both public and private colleges have accepted students with the highest possible SAT score, which is a 1600. 
