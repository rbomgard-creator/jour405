...
The appendix notes that the scales were not intended to be objective, meaning that individual differences in perspective or interpretation could influence how respondents answered.
...
1. What is the range of weights in this dataset? **Write your answer here:**The weights range from 0.23 to 3.04

2. What does it mean when a respondent has a weight of 0.23? What about 3.04? **Write your answer here:** If a respondent has a weight of 0.23, that means they're overrepresented, while a weight of 3.04 means they're underrepresented. 0.23 is weighed less to avoid skewing results, while 3.04 weighs more to make sure their group's perspective counts proportionally. 


3. Why might some respondents be weighted more heavily than others? **Write your answer here:** In order to avoid a skew, but also to make sure the end statistics match the rest of the population at a mroe accurate level. 
...
2. How might these differences affect reporting on likely voter turnout? **Write your answer here:** These differences could make certain groups appear more likely to vote than they actually are. 
...
These differences may exist due to some groups ability to vote confidently in comparison to others. Those less confident in voting are more likely to put "Unsure," which can lead to underrespresentation of those groups. This can include young voters, those with a lower income, or those less connected or interested in politics. 
