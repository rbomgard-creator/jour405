...
**Your answer**: If you treat the data like it's objective and you assume about it before even starting, you will face challenges. 

If you use a nice neighborhood in a city that's known to be crime ridden, your data is most likely to be skewed (sampling bias). 
Income and housing prices can also produce skewed results. In a city, most houses are moderately priced (lower incomes) with some higher priced outliers (higher incomes), which pulls the average up.
Household income: if one person in a household makes more than everyone else, that data can be skewed to the right (positive). 

To work on a story using data like this, more context to explain the distribution is always a good move. Look at the history of the subject you're writing an article on. Find the outliers in your data and explain why this throws off the distribution. Use median instead of mean. 
...
**Answer**: Maryland volleyball is in the top 20 for aces and in the 95th percentile. 5 percent of others have scored more aces than Maryland, but Maryland is scoring more aces than 95% of teams. 
...
**Answer**: The distribution is slightly skewed to the right. Most of the values are clustered around the mean, so one standard deviation covers most of the variance. 
