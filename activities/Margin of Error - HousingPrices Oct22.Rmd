...
**Submit the margin of error results here:** sample size 100: +/- 10, sample size 800: +/- 3.54, sample size 400: +/- 5
...
**Write your answers here:** The headline would not be statistically justified. The margin of error would make the low data equal to or under 50% for all sample sizes. A new headline could be, "Polls Show Split Vote for New City Policy."
...
After construction of a new Maryland transit line began, home values in surrounding areas began to rise. But can this increase be blamed completely on the line? Currently, the housing market has a historic buyer-seller gap nationwide. The biggest reason for this gap: growing economic uncertainty. The line is statistically significant to the increased prices, but not at a nationwide level. 
